<div class="card1">
    <div class="card1__wrapper">
        <div class="card1___wrapper-acounts">
            <div class="card1__score">+3</div>
            <div class="card1__acounts">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"
                    ><circle r="60" fill="#ffd8c9" cy="64" cx="64"></circle><circle
                        r="48"
                        opacity=".3"
                        fill="#fff"
                        cy="64"
                    ...
                    ></path><circle r="7" fill="#fbc0aa" cy="60" cx="89"></circle><path
                        fill="#00adfe"
                    ...
                    ></path><path fill="#f85565" d="m48.13 105h31.74l-.39-4h-30.96z"></path><path
                        fill="#ffd8c9"
                        d="m76 96a12 12 0 0 1 -24 0z"
                    ></path><path
                        stroke-width="14"
                        ...
                        fill="none"
                        d="m64 83v12"
                    ></path><circle r="7" fill="#fbc0aa" cy="60" cx="39"></circle><path
                        fill="#ffd8c9"
                    ...
                    ></path><path fill="#f85565" d="m47.35 113h33.29l-.38-4h-32.52z"></path><path
                        fill="#f85565"
                        d="m46.58 121h34.84l-.39-4h-34.06z"
                    ></path><path
                        opacity=".7"
                        fill="#ff8475"
                    ...
                    ></path><circle r="3" fill="#515570" cy="58.75" cx="76.25"></circle><path
                        stroke-linejoin="round"
                        stroke-linecap="round"
                        stroke="#515570"
                        fill="none"
                    ...
                    ></path><circle r="3" fill="#515570" cy="58.75" cx="51.75"></circle><g
                        stroke-linecap="round"
                        fill="none"
                        ><path
                            stroke-linejoin="round"
            ...
            <div class="card1__acounts">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"
                    ><circle r="60" fill="#ff8475" cy="64" cx="64"></circle><circle
                        r="48"
                        opacity=".4"
                        fill="#f85565"
                        cy="64"
                    ...
                    ></path><circle r="7" fill="#fbc0aa" cy="65" cx="89"></circle><path
                        fill="#4bc190"
                    ...
                    ></path><path fill="#fff" d="m57 123.68a58.54 58.54 0 0 0 14 0v-25.68h-14z"
                    ></path><path
                        stroke-width="14"
                        stroke-linejoin="round"
                        stroke-linecap="round"
                        ...
                        fill="none"
                        d="m64 88.75v9.75"
                    ></path><circle r="7" fill="#fbc0aa" cy="65" cx="39"></circle><path
                        fill="#ffd8c9"
                    ...
                    ></path><circle r="3" fill="#515570" cy="62.28" cx="76"></circle><circle
                        r="3"
                        fill="#515570"
                        cy="62.28"
                        cx="52"
                    ...
                    ></ellipse><ellipse
                        ...
                        cy="69.67"
                        cx="77.58"
                    ></ellipse><g stroke-linejoin="round" stroke-linecap="round" fill="none"
                        ><path stroke-width="4" stroke="#fbc0aa" d="m64 67v4"></path><path
                            stroke-width="2"
                            stroke="#515570"
                            opacity=".2"
                            d="m55 56h-9.25"
                        ></path><path stroke-width="2" stroke="#515570" opacity=".2" d="m82 56h-9.25"
                        ></path></g
                    ><path opacity=".4" fill="#f85565" d="m64 84c5 0 7-3 7-3h-14s2 3 7 3z"></path><path
                        fill="#f85565"
    ...
    <div class="card1__title" style="font-family: 'Raleway', font-wight: 600;">Review on Trends and Topics</div>
    <div class="card1__subtitle" style="font-family: 'Funnel Display';">
        You can also rate question which you are interested in
    </div>
    <div class="card1__indicator" style="font-family: 'Funnel Display';">
        <span class="card1__indicator-amount">135</span> Works /
        <span class="card1__indicator-percentage">45%</span>
    </div>
    <div class="card1__progress"><progress max="100" value="40"></progress></div>
</div>
...
<style>
	...
	.card1___wrapper-acounts > div:nth-child(2) {
		position: absolute;
		left: 25px;
		z-index: -1;
	}

	.card1___wrapper-acounts > div:nth-child(3) {
		position: absolute;
		left: 50px;
		z-index: -2;
	}
	...
	.card1__progress progress {
		width: 100%;
		height: 4px;
		border-radius: 100px;
	}

	.card1__progress progress::-webkit-progress-bar {
		background-color: #00000030;
		border-radius: 100px;
	}

	.card1__progress progress::-webkit-progress-value {
